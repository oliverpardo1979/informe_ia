...
\newcommand{\reportfigurewidth}{1.20\textwidth}
...
\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=\reportfigurewidth]{figures/fig_01_distribucion_exposicion.png}}
...
\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=\reportfigurewidth]{figures/fig_14_panel_ingreso_educacion.png}}
...
La Figura \ref{fig:genero_formalidad} muestra que la exposición promedio también varía por género y formalidad. El puntaje alcanza 0,297 entre las mujeres y 0,240 entre los hombres. Entre trabajadores formales es de 0,320, frente a 0,217 entre los informales.

\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=\reportfigurewidth]{figures/fig_15_panel_genero_formalidad.png}}
...
\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=\reportfigurewidth,height=0.80\textheight,keepaspectratio]{figures/fig_05_actividad_economica.png}}
...
\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=\reportfigurewidth,height=0.78\textheight,keepaspectratio]{figures/fig_04_departamentos.png}}
...
\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=\reportfigurewidth]{figures/fig_08_ocupaciones_alta_exposicion.png}}
...
La exposición aumenta con el ingreso, pero el margen de complementariedad también cambia a lo largo de la distribución. La Figura \ref{fig:razon_complementariedad_ingreso} muestra que la razón entre empleo en ocupaciones de alta y baja complementariedad aumenta de 0,75 en el primer quintil a 2,80 en el quinto. Hasta el tercer quintil, las ocupaciones de baja complementariedad tienen un mayor peso relativo; en los dos quintiles superiores la relación se invierte.

\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=\reportfigurewidth,height=0.76\textheight,keepaspectratio]{figures/fig_16_razon_complementariedad_ingreso.png}}
...
\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=\reportfigurewidth,height=0.76\textheight,keepaspectratio]{figures/fig_17_razon_complementariedad_relativa.png}}
