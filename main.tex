...
Los trabajadores de mayores ingresos están más expuestos, pero a la vez tienen una relación más complementaria con la IA. Entre los trabajadores de menores ingresos la exposición es menor, pero cuando existe exposición la complementariedad es más baja. 
...
La Figura \ref{fig:razon_complementariedad_relativa} muestra que el patrón se repite en otras dimensiones del mercado laboral. La complementariedad relativa aumenta con el nivel educativo: es inferior a uno entre quienes no tienen educación formal y considerablemente mayor entre trabajadores con educación superior. 

La razón entre trabajadores con complementariedad y trabajadores con sustituibilidad es cercana a uno entre las mujeres y cercana a dos entre los hombres. Esto quiere decir que las mujeres no solo están más expuestas sino que también ocupan labores más fácil de sustiruir por la IA. Mientras tanto los hombres están menos expuestos pero cuando lo están tiende a haber más complementariedad.

, mientras que alcanza 1,74 entre trabajadores formales y 0,92 entre informales.
