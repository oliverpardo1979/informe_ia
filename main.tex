...
El reto para Colombia consiste no solo en facilitar la adopción de la IA. También implica capacitar al trabajador en el uso de estas herramientas allí donde la IA  complementa al trabajador. Al mismo tiempo, el país debe fortalecer las capacidades de quienes se encuentran en ocupaciones con alta posibilidad de ser sustituidas para transitar hacia otras ocupaciones. El presente informe ayuda a identificar hacia qué ocupaciones deben orientarse estos esfuerzos.
...
No obstante, el efecto de la IA sobre los trabajadores puede ser positivo o negativo dependiendo de qué tanto las tareas realizadas por la IA complementan o sustituyen las tareas que queden en manos del trabajador. Si las complementan, el trabajador generará más valor agregado gracias a la IA, ayudando a mantener su puesto de trabajo y elevando su salario. Si las sustituyen, las empresas puede prescindir de estos trabajadores y presionar a la baja los salarios.
...
\caption{Exposición promedio por genero y formalidad}
...
\section{¿Qué ocurre cuando la inteligencia artificial realmente se adopta?}
